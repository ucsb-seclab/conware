...
conware-model-merge firmware/custom/servo/model.pickle experiments/lock/knock_ir_color.pickle -o experiments/lock/model.pickle
...
conware-emulate firmware/custom/servo/build_uninstrumented/servo.ino.bin -r experiments/lock/servo -m experiments/lock/model_optimized.pickle -t 1000
