...
conware-model-merge firmware/custom/color_sensor/model.pickle firmware/custom/color_sensor/model.pickle -o experiments/lock/model.pickle
...
conware-emulate firmware/custom/irremote/build_uninstrumented/irremote.ino.bin -r experiments/lock/color_sensor -m experiments/lock/model_optimized.pickle -t 1000
